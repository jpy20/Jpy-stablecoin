                ...
                <div className="flex justify-center items-center flex-col">
                    <div className="flex justify-center items-center border w-[40%] py-[40px] px-[30px] rounded-md mt-[30px] sm:w-full lg:w-[40%]">
                        ...
                        <div>
                            ...
                            <p className="w-[90%] sm:text-[15px] sm:w-full lg:w-[90%] lg:text-[16px]">for builders and buinesses JPY20 is merge with native currency, it can be receive in both crypto and native currency</p>
                        </div>
                    </div>
                    <div className="flex justify-center items-center border w-[40%] py-[40px] px-[30px] rounded-md mt-[30px] sm:w-full lg:w-[40%]">
                        ...
                        <div>
                            <h2 className="font-medium mb-[30px]">Trade and exchange JPY20</h2>
